...
namespace UnityEditor.VFX.Utils
{
    public class PointCacheUtil
    {
        ...
        public static PointCacheAsset GeneratePointCacheAsset(PCache pcache)
        {
            try
            {
        ...
        static private void SetPropValue(int index, Dictionary<OutProperty, Color> data, OutProperty prop, float val)
        {
            Color c = data[prop];
            ...
            {
                case 0:
                    if (prop.Size == 1 && prop.PropertyType == "int") c.a = val;
                    else c.r = val;
                    break;
                case 1:
                    c.g = val;
        ...
        static private void FindBestSize(int count, out int width, out int height)
        {
